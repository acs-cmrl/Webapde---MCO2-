...
/**
 * Servlet implementation class viewMixedPhotos
 */
@WebServlet("/viewPublicAndSharedPhotos")
public class viewPublicAndSharedPhotos extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public viewPublicAndSharedPhotos() {
        super();
